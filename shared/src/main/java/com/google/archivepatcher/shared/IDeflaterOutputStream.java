...
/**
 * Adapted from the original java.util.zip.DeflaterOutput.OutputStream to use IDeflater instead of Deflater.
 * <p>
 ...
 */
public
class IDeflaterOutputStream extends FilterOutputStream {
    /**
     * Compressor for this stream.
     */
    protected IDeflater def;
     ...
     * @since 1.7
     */
    public IDeflaterOutputStream(OutputStream out,
                                IDeflater def,
                                int size,
                                boolean syncFlush) {
        super(out);
     ...
     */
    public IDeflaterOutputStream(OutputStream out, IDeflater def, int size) {
     ...
     * If {@link #IDeflaterOutputStream(OutputStream, IDeflater, int, boolean)
